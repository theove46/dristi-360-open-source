...
import 'package:dristi_open_source/features/destination/widgets/destination_items_builder.dart';
...
class _DestinationScreenState
  ...
  Future<void> _fetchComponents(String? language) async {
    ...
    ref
        ...
        .getDestinationData(currentLanguageState, widget.id);
    ref
        .read(destinationItemsProvider.notifier)
        .getDestinationItems(currentLanguageState);
    ref
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
            SpotScreenImage(stateData: destinationDataState.data),
            _buildDescription(),
            SpotScreenTopIcons(
              itemId: widget.id,
              isFavoriteProvider:
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  DestinationScreenItemsBuilder(instanceId: widget.instanceId),
                ],
              ),
            ),
          ),
